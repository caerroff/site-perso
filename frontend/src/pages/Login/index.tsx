        ...
        <>
            <div className="mx-5 space-y-5 md:mx-[10%] my-[5%] p-[2%] bg-gray-700 text-center rounded-xl md:rounded-3xl text-white">
                ...
                <div className='flex flex-col items-center space-y-5'>
                    ...
                    <div className='rounded-2xl'><input type='password' className='focus:outline focus:outline-slate-400 bg-gray-500 h-10 w-64 text-white rounded-l-xl text-center outline-' placeholder='Password' id='password' ></input><button id='eye' className='fa fa-eye h-10 bg-gray-500 text-black p-1 rounded-r-xl' onClick={() => { showPassword() }} /></div>
